...
solr_url = "http://localhost:8983/solr/quati_lema/select"  # ou o core que você está usando

# Modo COM lematização
output_com_lema = "resultados_com_lema.csv"
# Modo SEM lematização
output_sem_lema = "resultados_sem_lema.csv"

relevant_ids = get_relevant_query_ids(qrels_path)
consultas = carregar_consultas_relevantes(topics_path, relevant_ids)

print("🔎 Consultando campo com lematização...")
consultar_solr(consultas, solr_url, output_com_lema, campo="texto_com_lema")

print("\n🔎 Consultando campo sem lematização...")
consultar_solr(consultas, solr_url, output_sem_lema, campo="texto_sem_lema")
